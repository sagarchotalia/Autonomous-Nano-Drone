...
def main():
    ...
    rospy.Subscriber("/whycon/detected", Bool, found_callback)
    ...
    while not rospy.is_shutdown():
        gains = str(pid_throttle[0]) +","+ str(pid_throttle[1]) +","+ str(pid_throttle[2]) +","+ str(pid_roll[0]) +","+ str(pid_roll[1]) +","+ str(pid_roll[2]) +","+ str(pid_pitch[0]) +","+ str(pid_pitch[1]) +","+ str(pid_pitch[2]) +","+ str(round(z,4)) +","+ str(round(x,4)) +","+ str(round(y,4)) + "," + str(detected)
