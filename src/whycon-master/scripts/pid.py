...
if __name__ == "__main__":
    ...
    throttle_pub = rospy.Publisher('/throttle', PidTune, queue_size=1000, latch=True)
    pitch_pub = rospy.Publisher('/pitch', PidTune, queue_size=1000, latch=True)
    roll_pub = rospy.Publisher('/roll', PidTune, queue_size=1000, latch=True)
    root.mainloop()